...
export class SLabel extends React.Component
{
    ...
    createStyles(theme)
    {
      const style = StyleSheet.create({
        ...
        lblTopContain:{
          ...
          shadowOpacity:this.props.shadow ? .4 : 0,
          ...
          lblText: {
            ...
            color: this.props.textColor ? this.props.textColor :  theme.color.labelText,
    ...
    render() 
    {
      ...
      return(
          <View  style={[this.styles.lblTopContain,this.props.style]} {...this.props} >
              <View style={this.styles.lblContainer}>
                  <Icon name={this.props.IconName ? this.props.IconName : "sent"} size={this.props.IconSize ? this.props.IconSize : this.theme.scale*15} style={this.styles.btnIcon}/>
