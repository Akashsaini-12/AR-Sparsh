...
const CustomMacpComponent = props => {
  const {item, theme} = props;
  const {id, type, dateofGrant, ptoNo, remarks} = item;
  ...
  return (
    <TouchableOpacity style={styles(theme).container2}>
      <View style={styles(theme).downContainer}>
        ...
        <View style={styles(theme).summaryDiv}>
          <Text style={styles(theme).textTypo}>Type :</Text>
          <Text style={styles(theme).textTypo}>{type}</Text>
        </View>
        <View style={styles(theme).summaryDiv}>
          <Text style={styles(theme).textTypo}>Date of Grant :</Text>
          <Text style={styles(theme).textTypo}>{dateofGrant}</Text>
        </View>
        <View style={styles(theme).summaryDiv}>
...
export default CustomMacpComponent;
const styles = theme =>
  StyleSheet.create({
    mainContainer: {
      flex: 1,
