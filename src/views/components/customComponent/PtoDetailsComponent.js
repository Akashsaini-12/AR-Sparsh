import {
  ...
  const PtoDetailsComponent = props => {
    const {item, theme} = props;
    const {id, serialNo, desription, ptoNo, date} = item;
      ...
      <TouchableOpacity style={styles(theme).container2}>
        ...
        <View style={styles(theme).downContainer}>
          ...
          <View style={styles(theme).summaryDiv}>
            <Text style={styles(theme).textTypo}>Serial No :</Text>
            <Text style={styles(theme).textTypo}>{serialNo}</Text>
          </View>
          <View style={styles(theme).summaryDiv}>
            <Text style={styles(theme).textTypo}>Desription :</Text>
            <Text style={styles(theme).textTypo}>{desription}</Text>
          </View>
          <View style={styles(theme).summaryDiv}>
          ...
          <View style={styles(theme).summaryDiv}>
            <Text style={styles(theme).textTypo}>Date :</Text>
            <Text style={styles(theme).textTypo}>{date}</Text>
          </View>
        </View>
  ...
  export default PtoDetailsComponent;
  const styles = theme =>
    StyleSheet.create({
      mainContainer: {
        flex: 1,
