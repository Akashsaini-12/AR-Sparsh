...
import CustomGrievanceComponent from '../../components/CustomFlatlisitComponent/CustomGrievanceComponent';
...
export default class NormalGrievance extends Component {
  constructor(props) {
    super(props);
  ...
  Data = [
    {id: '1', title: 'Doc Reqd For Various Claims', iconName: 'file-copy'},
    {id: '2', title: 'Status of Claims', iconName: 'list'},
    {id: '3', title: 'Forthcomming ESM Raily Updates', iconName: 'file-copy'},
    {id: '2', title: 'Status of Claims', iconName: 'list'},
    {id: '3', title: 'Forthcomming ESM Raily Updates', iconName: 'file-copy'},
  ];
